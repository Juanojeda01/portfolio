...
Group by 
  continent 
order by 
  TotalDeathCount desc -- CIFRAS GLOBALES
Select 
...
order by 
  1, 
  2 -- Total Population vs Vaccinations
Select 
  dea.continent, 
  dea.location, 
  dea.date, 
...
From 
  Proyect..covid_deaths dea 
  Join Proyect..covid_vaccinations vac On dea.location = vac.location 
